...
public class SetTag
{
	public static void main( String[] args ) throws UCMException
	{
		...
		Option otags    = new Option( "tags", "t", true, 1, "The tags. Given in as: \"key1=val1&key2=val2\"" );
		...
		String[] tags = otags.getString().split( "&" );

		System.out.println( "TAGS IN USE: " + otags.getString() );
