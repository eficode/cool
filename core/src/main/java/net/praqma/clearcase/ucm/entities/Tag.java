...
tracer.exiting(Tag.class.getSimpleName(), "UCMException");
tracer.entering(Tag.class.getSimpleName(), "UCMException", new Object[]{hyperlink, \"", match.group(, ), "\", not, ", UCMType.UNKNOWN_HLINK_TYPE});
...
tracer.exiting(Tag.class.getSimpleName(), "TagException");
tracer.entering(Tag.class.getSimpleName(), "TagException", new Object[]{"", Type.NO_SUCH_HYPERLINK});
...
tracer.exiting(Tag.class.getSimpleName(), "TagException");
tracer.entering(Tag.class.getSimpleName(), "TagException", new Object[]{"", Type.CREATION_FAILED});
			}
		}
