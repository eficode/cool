...
public class Stream extends UCMEntity implements Diffable, Serializable, StreamContainable {
	...
	public List<Baseline> getBaselines( PromotionLevel plevel ) throws UnableToInitializeEntityException, UnableToListBaselinesException, NoSingleTopComponentException {
		tracer.entering(Stream.class.getSimpleName(), "getBaselines", new Object[]{plevel});
		tracer.exiting(Stream.class.getSimpleName(), "getBaselines", Baselines.get( this, getSingleTopComponent(), plevel ));
	...
	public List<Baseline> getBaselines( Component component, PromotionLevel plevel ) throws UnableToInitializeEntityException, UnableToListBaselinesException {
		tracer.entering(Stream.class.getSimpleName(), "getBaselines", new Object[]{component, plevel});
		tracer.exiting(Stream.class.getSimpleName(), "getBaselines", Baselines.get( this, component, plevel ));
	...
	public List<Baseline> getBaselines( Component component, PromotionLevel plevel, Date date ) throws UnableToInitializeEntityException, UnableToListBaselinesException {
		tracer.entering(Stream.class.getSimpleName(), "getBaselines", new Object[]{component, plevel, date});
		...
		tracer.exiting(Stream.class.getSimpleName(), "getBaselines", baselines);
		return baselines;
	}
	...
	public List<Stream> getChildStreams( boolean multisitePolling ) throws UnableToInitializeEntityException, CleartoolException {
		tracer.entering(Stream.class.getSimpleName(), "getChildStreams", new Object[]{multisitePolling});
		...
		if( !loaded ) {
			...
			tracer.exiting(Stream.class.getSimpleName(), "getChildStreams", streams);
			return streams;
		}
		...
		public List<Baseline> getPostedBaselines( Component component, PromotionLevel plevel ) throws UnableToInitializeEntityException {
			tracer.entering(Stream.class.getSimpleName(), "getPostedBaselines", new Object[]{component, plevel});
			...
			tracer.exiting(Stream.class.getSimpleName(), "getPostedBaselines", res);
			return res;
		}
